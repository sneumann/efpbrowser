...
class Image:
    ...
    ##
    # New in version 1.1.6efp
    # Replaces color1 of all pixels in image map with color2 in this image
    # @param map reference image with color1 to replace
    # @param color1 color to replace
    # @param color2 new color in target image

    def replaceFill(self, map, color1, color2):
        self.load()
        return self.im.replaceFill(map.im, color1, color2);
